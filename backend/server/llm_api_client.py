...
llm_api_client = LLMAPIClient(
    api_url="https://openrouter.ai/api/v1",  # Replace with your actual API URL from config
    api_key=os.getenv("OPENROUTER_API_KEY")   # Replace with your actual API key from config
)
